...
import { 
  ...
  Wallet, PieChart, Bell, Settings, ShieldCheck, LogOut 
} from 'lucide-react';
...
export const NAV_ITEMS = [
  ...
  { id: Screen.BIDS, label: 'Bids Viewer', icon: <ListChecks size={20} /> },
  { id: Screen.WITHDRAWALS, label: 'Withdraw Requests', icon: <Wallet size={20} /> },
  { id: Screen.FINANCE, label: 'Finance Reports', icon: <PieChart size={20} /> },
