...
const BidsScreen: React.FC<BidsScreenProps> = ({ bids, setBids }) => {
  ...
  const filteredBids = useMemo(() => {
    return bids.filter(bid => {
      ...
      const matchesDate = !filterDate || bid.date === filterDate;
      ...
      return matchesGame && matchesType && matchesDate && matchesSearch;
    });
  }, [filterGame, filterType, filterDate, searchTerm, bids]);
